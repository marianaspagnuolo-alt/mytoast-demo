...
- `_hero/` — app screenshots used in the hero carousel
- `App Icon.svg` — app icon used in the logo and browser tab
...
Replace any image in the `_hero/` folder with the same filename, then commit and push.

## Owner

Mariana Spagnuolo — Product Design, Team Suite
